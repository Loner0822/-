...
// ************************************************************************ //
#ifndef   __FlashVideoObjects_TLB_h__
#define   __FlashVideoObjects_TLB_h__
...
// *********************************************************************//
extern __declspec (package) const GUID LIBID_FlashVideoObjects;
extern __declspec (package) const GUID IID_IFlashVideo;
extern __declspec (package) const GUID IID_ICanHandleException;
extern __declspec (package) const GUID DIID__IFlashVideoEvents;
extern __declspec (package) const GUID CLSID_FlashVideo;
...
// *********************************************************************//
interface DECLSPEC_UUID("{D27CDB6C-AE6D-11CF-96B8-444553540000}") IFlashVideo;
typedef TComInterface<IFlashVideo, &IID_IFlashVideo> IFlashVideoPtr;
...
interface DECLSPEC_UUID("{D27CDB6D-AE6D-11CF-96B8-444553540000}") _IFlashVideoEvents;
typedef TComInterface<_IFlashVideoEvents, &DIID__IFlashVideoEvents> _IFlashVideoEventsPtr;
...
// change.                                                                
// *********************************************************************//
typedef IFlashVideo FlashVideo;
typedef IFlashVideoPtr FlashVideoPtr;
...
#define LIBID_OF_FlashVideo (&LIBID_FlashVideoObjects)
#define LIBID_OF_FlashObjectInterface (&LIBID_FlashVideoObjects)
#define LIBID_OF_FlashObject (&LIBID_FlashVideoObjects)
// *********************************************************************//
// Interface: IFlashVideo
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {D27CDB6C-AE6D-11CF-96B8-444553540000}
// *********************************************************************//
interface IFlashVideo  : public IDispatch
{
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE get_Playing(TOLEBOOL* pVal/*[out,retval]*/) = 0;
  // [125] property Playing
  virtual HRESULT STDMETHODCALLTYPE set_Playing(TOLEBOOL pVal/*[in]*/) = 0;
  ...
  // [106] property Loop
  virtual HRESULT STDMETHODCALLTYPE get_Loop(TOLEBOOL* pVal/*[out,retval]*/) = 0;
  // [106] property Loop
  virtual HRESULT STDMETHODCALLTYPE set_Loop(TOLEBOOL pVal/*[in]*/) = 0;
  // [102] property Movie
  ...
  virtual HRESULT STDMETHODCALLTYPE IsPlaying(TOLEBOOL* Playing/*[out,retval]*/) = 0;
  ...
  // [135] property Menu
  virtual HRESULT STDMETHODCALLTYPE get_Menu(TOLEBOOL* pVal/*[out,retval]*/) = 0;
  // [135] property Menu
  virtual HRESULT STDMETHODCALLTYPE set_Menu(TOLEBOOL pVal/*[in]*/) = 0;
  // [136] property Base
  ...
  virtual HRESULT STDMETHODCALLTYPE get_DeviceFont(TOLEBOOL* pVal/*[out,retval]*/) = 0;
  // [138] property DeviceFont
  virtual HRESULT STDMETHODCALLTYPE set_DeviceFont(TOLEBOOL pVal/*[in]*/) = 0;
  // [139] property EmbedMovie
  virtual HRESULT STDMETHODCALLTYPE get_EmbedMovie(TOLEBOOL* pVal/*[out,retval]*/) = 0;
  // [139] property EmbedMovie
  virtual HRESULT STDMETHODCALLTYPE set_EmbedMovie(TOLEBOOL pVal/*[in]*/) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE get_SeamlessTabbing(TOLEBOOL* pVal/*[out,retval]*/) = 0;
  // [192] property SeamlessTabbing
  virtual HRESULT STDMETHODCALLTYPE set_SeamlessTabbing(TOLEBOOL pVal/*[in]*/) = 0;
  // [193] method EnforceLocalSecurity
  virtual HRESULT STDMETHODCALLTYPE EnforceLocalSecurity(void) = 0;
  // [194] property Profile
  virtual HRESULT STDMETHODCALLTYPE get_Profile(TOLEBOOL* pVal/*[out,retval]*/) = 0;
  // [194] property Profile
  virtual HRESULT STDMETHODCALLTYPE set_Profile(TOLEBOOL pVal/*[in]*/) = 0;
  ...
  TOLEBOOL __fastcall get_Playing(void)
  {
    TOLEBOOL pVal;
    OLECHECK(this->get_Playing((TOLEBOOL*)&pVal));
    return pVal;
  }
  ...
  TOLEBOOL __fastcall get_Loop(void)
  {
    TOLEBOOL pVal;
    OLECHECK(this->get_Loop((TOLEBOOL*)&pVal));
    return pVal;
  }
  ...
  {
    TOLEBOOL Playing;
    OLECHECK(this->IsPlaying((TOLEBOOL*)&Playing));
    return Playing;
  }
  ...
  {
    TOLEBOOL loaded;
    OLECHECK(this->FrameLoaded(FrameNum, (TOLEBOOL*)&loaded));
    return loaded;
  }
  ...
  TOLEBOOL __fastcall get_Menu(void)
  {
    TOLEBOOL pVal;
    OLECHECK(this->get_Menu((TOLEBOOL*)&pVal));
    return pVal;
  }
  ...
  TOLEBOOL __fastcall get_DeviceFont(void)
  {
    TOLEBOOL pVal;
    OLECHECK(this->get_DeviceFont((TOLEBOOL*)&pVal));
    return pVal;
  }

  TOLEBOOL __fastcall get_EmbedMovie(void)
  {
    TOLEBOOL pVal;
    OLECHECK(this->get_EmbedMovie((TOLEBOOL*)&pVal));
    return pVal;
  }
  ...
  TOLEBOOL __fastcall get_SeamlessTabbing(void)
  {
    TOLEBOOL pVal;
    OLECHECK(this->get_SeamlessTabbing((TOLEBOOL*)&pVal));
    return pVal;
  }

  TOLEBOOL __fastcall get_Profile(void)
  {
    TOLEBOOL pVal;
    OLECHECK(this->get_Profile((TOLEBOOL*)&pVal));
    return pVal;
  }
  ...
  __property   TOLEBOOL        Playing = {read = get_Playing, write = set_Playing};
  ...
  __property   TOLEBOOL        Loop = {read = get_Loop, write = set_Loop};
  ...
  __property   TOLEBOOL        Menu = {read = get_Menu, write = set_Menu};
  __property   BSTR            Base = {read = get_Base, write = set_Base};
  __property   BSTR            Scale = {read = get_Scale, write = set_Scale};
  __property   TOLEBOOL        DeviceFont = {read = get_DeviceFont, write = set_DeviceFont};
  __property   TOLEBOOL        EmbedMovie = {read = get_EmbedMovie, write = set_EmbedMovie};
  ...
  __property   TOLEBOOL        SeamlessTabbing = {read = get_SeamlessTabbing, write = set_SeamlessTabbing};
  __property   TOLEBOOL        Profile = {read = get_Profile, write = set_Profile};
...
{
public:
  virtual HRESULT STDMETHODCALLTYPE CanHandleException(System::TGUID* pExcepInfo/*[in]*/,
                                                       TVariant* pvar/*[in]*/) = 0; // [-1]
};

// *********************************************************************//
// Interface: _IFlashVideoEvents
// Flags:     (4112) Hidden Dispatchable
// GUID:      {D27CDB6D-AE6D-11CF-96B8-444553540000}
// *********************************************************************//
interface _IFlashVideoEvents : public TDispWrapper<IDispatch>
{
...
public:
   ...
   HRESULT STDMETHODCALLTYPE RemoteInvokeEx(long id/*[in]*/, unsigned_long lcid/*[in]*/, 
                                            unsigned_long dwFlags/*[in]*/, System::TGUID* pdp/*[in]*/,
                                            TVariant* pvarRes/*[out]*/, System::TGUID* pei/*[out]*/,
                                            Flashvideoobjects_tlb::IServiceProviderPtr pspCaller/*[in]*/, 
                                            unsigned cvarRefArg/*[in]*/, unsigned* rgiRefArg/*[in]*/, 
                                            TVariant* rgvarRefArg/*[in,out]*/); // [-1]
...
// *********************************************************************//
interface IFlashObjectInterface  : public Flashvideoobjects_tlb::IDispatchEx
{
public:
};
...
// *********************************************************************//
interface IFlashObject  : public Flashvideoobjects_tlb::IDispatchEx
{
public:
...
#if !defined(__TLB_NO_INTERFACE_WRAPPERS)
// *********************************************************************//
// SmartIntf: TCOMIFlashVideo
// Interface: IFlashVideo
// *********************************************************************//
template <class T /* IFlashVideo */ >
class TCOMIFlashVideoT : public TComInterface<IFlashVideo>, public TComInterfaceBase<IUnknown>
{
public:
  TCOMIFlashVideoT() {}
  TCOMIFlashVideoT(IFlashVideo *intf, bool addRef = false) : TComInterface<IFlashVideo>(intf, addRef) {}
  TCOMIFlashVideoT(const TCOMIFlashVideoT& src) : TComInterface<IFlashVideo>(src) {}
  TCOMIFlashVideoT& operator=(const TCOMIFlashVideoT& src) { Bind(src, true); return *this;}

  HRESULT         __fastcall get_ReadyState(long* pVal/*[out,retval]*/);
  long            __fastcall get_ReadyState(void);
  HRESULT         __fastcall get_TotalFrames(long* pVal/*[out,retval]*/);
  long            __fastcall get_TotalFrames(void);
  HRESULT         __fastcall get_Playing(TOLEBOOL* pVal/*[out,retval]*/);
  TOLEBOOL        __fastcall get_Playing(void);
  HRESULT         __fastcall set_Playing(TOLEBOOL pVal/*[in]*/);
  ...
  HRESULT         __fastcall get_Loop(TOLEBOOL* pVal/*[out,retval]*/);
  TOLEBOOL        __fastcall get_Loop(void);
  HRESULT         __fastcall set_Loop(TOLEBOOL pVal/*[in]*/);
  ...
  long            __fastcall CurrentFrame(void);
  HRESULT         __fastcall IsPlaying(TOLEBOOL* Playing/*[out,retval]*/);
  TOLEBOOL        __fastcall IsPlaying(void);
  HRESULT         __fastcall PercentLoaded(long* percent/*[out,retval]*/);
  long            __fastcall PercentLoaded(void);
  HRESULT         __fastcall FrameLoaded(long FrameNum/*[in]*/, TOLEBOOL* loaded/*[out,retval]*/);
  TOLEBOOL        __fastcall FrameLoaded(long FrameNum/*[in]*/);
  ...
  HRESULT         __fastcall get_Menu(TOLEBOOL* pVal/*[out,retval]*/);
  TOLEBOOL        __fastcall get_Menu(void);
  HRESULT         __fastcall set_Menu(TOLEBOOL pVal/*[in]*/);
  ...
  HRESULT         __fastcall get_DeviceFont(TOLEBOOL* pVal/*[out,retval]*/);
  TOLEBOOL        __fastcall get_DeviceFont(void);
  HRESULT         __fastcall set_DeviceFont(TOLEBOOL pVal/*[in]*/);
  HRESULT         __fastcall get_EmbedMovie(TOLEBOOL* pVal/*[out,retval]*/);
  TOLEBOOL        __fastcall get_EmbedMovie(void);
  HRESULT         __fastcall set_EmbedMovie(TOLEBOOL pVal/*[in]*/);
  ...
  HRESULT         __fastcall get_SeamlessTabbing(TOLEBOOL* pVal/*[out,retval]*/);
  TOLEBOOL        __fastcall get_SeamlessTabbing(void);
  HRESULT         __fastcall set_SeamlessTabbing(TOLEBOOL pVal/*[in]*/);
  HRESULT         __fastcall EnforceLocalSecurity(void);
  HRESULT         __fastcall get_Profile(TOLEBOOL* pVal/*[out,retval]*/);
  TOLEBOOL        __fastcall get_Profile(void);
  HRESULT         __fastcall set_Profile(TOLEBOOL pVal/*[in]*/);
...
typedef TCOMIFlashVideoT<IFlashVideo> TCOMIFlashVideo;

// *********************************************************************//
// DispIntf:  IFlashVideo
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {D27CDB6C-AE6D-11CF-96B8-444553540000}
// *********************************************************************//
template<class T>
class IFlashVideoDispT : public TAutoDriver<IFlashVideo>
{
public:
  IFlashVideoDispT(){}

  IFlashVideoDispT(IFlashVideo *pintf)
  {
    TAutoDriver<IFlashVideo>::Bind(pintf, false);
  }

  IFlashVideoDispT(IFlashVideoPtr pintf)
  {
    TAutoDriver<IFlashVideo>::Bind(pintf, true);
  }

  IFlashVideoDispT& operator=(IFlashVideo *pintf)
  {
    TAutoDriver<IFlashVideo>::Bind(pintf, false);
    return *this;
  }

  IFlashVideoDispT& operator=(IFlashVideoPtr pintf)
  {
    TAutoDriver<IFlashVideo>::Bind(pintf, true);
    return *this;
  }
  ...
  HRESULT BindDefault()
  {
    return OLECHECK(Bind(CLSID_FlashVideo));
  }

  HRESULT BindRunning()
  {
    return BindToActive(CLSID_FlashVideo);
  }
...
typedef IFlashVideoDispT<IFlashVideo> IFlashVideoDisp;

typedef TComInterface<ICanHandleException>  TCOMICanHandleException;

// *********************************************************************//
// DispIntf:  _IFlashVideoEvents
// Flags:     (4112) Hidden Dispatchable
// GUID:      {D27CDB6D-AE6D-11CF-96B8-444553540000}
// *********************************************************************//
template <class T>
class _IFlashVideoEventsDispT : public TAutoDriver<_IFlashVideoEvents>
{
public:
  _IFlashVideoEventsDispT(){}
...
typedef _IFlashVideoEventsDispT<_IFlashVideoEvents> _IFlashVideoEventsDisp;
...
public:
  ...
  HRESULT         __fastcall RemoteInvokeEx(long id/*[in]*/, unsigned_long lcid/*[in]*/, 
                                            ...
                                            /*AUTO_PARAM_ERROR(TGUID* pdp)*/ TVariant&  pdp, 
                                            TVariant* pvarRes/*[out]*/, 
                                            /*AUTO_PARAM_ERROR(TGUID* pei)*/ TVariant&  pei, 
                                            Flashvideoobjects_tlb::IServiceProviderPtr pspCaller/*[in]*/
                                            , unsigned cvarRefArg/*[in]*/, 
                                            unsigned* rgiRefArg/*[in]*/, 
                                            TVariant* rgvarRefArg/*[in,out]*/);
...
TCOMIFlashVideoT<T>::get_ReadyState(long* pVal/*[out,retval]*/)
{
  return (*this)->get_ReadyState(pVal);
}

template <class T> long __fastcall
TCOMIFlashVideoT<T>::get_ReadyState(void)
{
  long pVal;
  OLECHECK(this->get_ReadyState((long*)&pVal));
  return pVal;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::get_TotalFrames(long* pVal/*[out,retval]*/)
{
  return (*this)->get_TotalFrames(pVal);
}

template <class T> long __fastcall
TCOMIFlashVideoT<T>::get_TotalFrames(void)
{
  long pVal;
  OLECHECK(this->get_TotalFrames((long*)&pVal));
  return pVal;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::get_Playing(TOLEBOOL* pVal/*[out,retval]*/)
{
  return (*this)->get_Playing(pVal);
}

template <class T> TOLEBOOL __fastcall
TCOMIFlashVideoT<T>::get_Playing(void)
{
  TOLEBOOL pVal;
  OLECHECK(this->get_Playing((TOLEBOOL*)&pVal));
  return pVal;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::set_Playing(TOLEBOOL pVal/*[in]*/)
{
  return (*this)->set_Playing(pVal);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::get_Quality(int* pVal/*[out,retval]*/)
{
  return (*this)->get_Quality(pVal);
}

template <class T> int __fastcall
TCOMIFlashVideoT<T>::get_Quality(void)
{
  int pVal;
  OLECHECK(this->get_Quality((int*)&pVal));
  return pVal;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::set_Quality(int pVal/*[in]*/)
{
  return (*this)->set_Quality(pVal);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::get_ScaleMode(int* pVal/*[out,retval]*/)
{
  return (*this)->get_ScaleMode(pVal);
}

template <class T> int __fastcall
TCOMIFlashVideoT<T>::get_ScaleMode(void)
{
  int pVal;
  OLECHECK(this->get_ScaleMode((int*)&pVal));
  return pVal;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::set_ScaleMode(int pVal/*[in]*/)
{
  return (*this)->set_ScaleMode(pVal);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::get_AlignMode(int* pVal/*[out,retval]*/)
{
  return (*this)->get_AlignMode(pVal);
}

template <class T> int __fastcall
TCOMIFlashVideoT<T>::get_AlignMode(void)
{
  int pVal;
  OLECHECK(this->get_AlignMode((int*)&pVal));
  return pVal;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::set_AlignMode(int pVal/*[in]*/)
{
  return (*this)->set_AlignMode(pVal);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::get_BackgroundColor(long* pVal/*[out,retval]*/)
{
  return (*this)->get_BackgroundColor(pVal);
}

template <class T> long __fastcall
TCOMIFlashVideoT<T>::get_BackgroundColor(void)
{
  long pVal;
  OLECHECK(this->get_BackgroundColor((long*)&pVal));
  return pVal;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::set_BackgroundColor(long pVal/*[in]*/)
{
  return (*this)->set_BackgroundColor(pVal);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::get_Loop(TOLEBOOL* pVal/*[out,retval]*/)
{
  return (*this)->get_Loop(pVal);
}

template <class T> TOLEBOOL __fastcall
TCOMIFlashVideoT<T>::get_Loop(void)
{
  TOLEBOOL pVal;
  OLECHECK(this->get_Loop((TOLEBOOL*)&pVal));
  return pVal;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::set_Loop(TOLEBOOL pVal/*[in]*/)
{
  return (*this)->set_Loop(pVal);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::get_Movie(BSTR* pVal/*[out,retval]*/)
{
  return (*this)->get_Movie(pVal);
}

template <class T> BSTR __fastcall
TCOMIFlashVideoT<T>::get_Movie(void)
{
  BSTR pVal = 0;
  OLECHECK(this->get_Movie((BSTR*)&pVal));
  return pVal;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::set_Movie(BSTR pVal/*[in]*/)
{
  return (*this)->set_Movie(pVal);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::get_FrameNum(long* pVal/*[out,retval]*/)
{
  return (*this)->get_FrameNum(pVal);
}

template <class T> long __fastcall
TCOMIFlashVideoT<T>::get_FrameNum(void)
{
  long pVal;
  OLECHECK(this->get_FrameNum((long*)&pVal));
  return pVal;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::set_FrameNum(long pVal/*[in]*/)
{
  return (*this)->set_FrameNum(pVal);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::SetZoomRect(long left/*[in]*/, long top/*[in]*/, long right/*[in]*/, 
                                     long bottom/*[in]*/)
{
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::Zoom(int factor/*[in]*/)
{
  return (*this)->Zoom(factor);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::Pan(long x/*[in]*/, long y/*[in]*/, int mode/*[in]*/)
{
  return (*this)->Pan(x, y, mode);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::Play(void)
{
  return (*this)->Play();
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::Stop(void)
{
  return (*this)->Stop();
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::Back(void)
{
  return (*this)->Back();
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::Forward(void)
{
  return (*this)->Forward();
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::Rewind(void)
{
  return (*this)->Rewind();
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::StopPlay(void)
{
  return (*this)->StopPlay();
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::GotoFrame(long FrameNum/*[in]*/)
{
  return (*this)->GotoFrame(FrameNum);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::CurrentFrame(long* FrameNum/*[out,retval]*/)
{
  return (*this)->CurrentFrame(FrameNum);
}

template <class T> long __fastcall
TCOMIFlashVideoT<T>::CurrentFrame(void)
{
  long FrameNum;
  OLECHECK(this->CurrentFrame((long*)&FrameNum));
  return FrameNum;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::IsPlaying(TOLEBOOL* Playing/*[out,retval]*/)
{
  return (*this)->IsPlaying(Playing);
}

template <class T> TOLEBOOL __fastcall
TCOMIFlashVideoT<T>::IsPlaying(void)
{
  TOLEBOOL Playing;
  OLECHECK(this->IsPlaying((TOLEBOOL*)&Playing));
  return Playing;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::PercentLoaded(long* percent/*[out,retval]*/)
{
  return (*this)->PercentLoaded(percent);
}

template <class T> long __fastcall
TCOMIFlashVideoT<T>::PercentLoaded(void)
{
  long percent;
  OLECHECK(this->PercentLoaded((long*)&percent));
  return percent;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::FrameLoaded(long FrameNum/*[in]*/, TOLEBOOL* loaded/*[out,retval]*/)
{
  return (*this)->FrameLoaded(FrameNum, loaded);
}

template <class T> TOLEBOOL __fastcall
TCOMIFlashVideoT<T>::FrameLoaded(long FrameNum/*[in]*/)
{
  TOLEBOOL loaded;
  OLECHECK(this->FrameLoaded(FrameNum, (TOLEBOOL*)&loaded));
  return loaded;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::FlashVersion(long* version/*[out,retval]*/)
{
  return (*this)->FlashVersion(version);
}

template <class T> long __fastcall
TCOMIFlashVideoT<T>::FlashVersion(void)
{
  long version;
  OLECHECK(this->FlashVersion((long*)&version));
  return version;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::get_WMode(BSTR* pVal/*[out,retval]*/)
{
  return (*this)->get_WMode(pVal);
}

template <class T> BSTR __fastcall
TCOMIFlashVideoT<T>::get_WMode(void)
{
  BSTR pVal = 0;
  OLECHECK(this->get_WMode((BSTR*)&pVal));
  return pVal;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::set_WMode(BSTR pVal/*[in]*/)
{
  return (*this)->set_WMode(pVal);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::get_SAlign(BSTR* pVal/*[out,retval]*/)
{
  return (*this)->get_SAlign(pVal);
}

template <class T> BSTR __fastcall
TCOMIFlashVideoT<T>::get_SAlign(void)
{
  BSTR pVal = 0;
  OLECHECK(this->get_SAlign((BSTR*)&pVal));
  return pVal;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::set_SAlign(BSTR pVal/*[in]*/)
{
  return (*this)->set_SAlign(pVal);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::get_Menu(TOLEBOOL* pVal/*[out,retval]*/)
{
  return (*this)->get_Menu(pVal);
}

template <class T> TOLEBOOL __fastcall
TCOMIFlashVideoT<T>::get_Menu(void)
{
  TOLEBOOL pVal;
  OLECHECK(this->get_Menu((TOLEBOOL*)&pVal));
  return pVal;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::set_Menu(TOLEBOOL pVal/*[in]*/)
{
  return (*this)->set_Menu(pVal);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::get_Base(BSTR* pVal/*[out,retval]*/)
{
  return (*this)->get_Base(pVal);
}

template <class T> BSTR __fastcall
TCOMIFlashVideoT<T>::get_Base(void)
{
  BSTR pVal = 0;
  OLECHECK(this->get_Base((BSTR*)&pVal));
  return pVal;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::set_Base(BSTR pVal/*[in]*/)
{
  return (*this)->set_Base(pVal);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::get_Scale(BSTR* pVal/*[out,retval]*/)
{
  return (*this)->get_Scale(pVal);
}

template <class T> BSTR __fastcall
TCOMIFlashVideoT<T>::get_Scale(void)
{
  BSTR pVal = 0;
  OLECHECK(this->get_Scale((BSTR*)&pVal));
  return pVal;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::set_Scale(BSTR pVal/*[in]*/)
{
  return (*this)->set_Scale(pVal);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::get_DeviceFont(TOLEBOOL* pVal/*[out,retval]*/)
{
  return (*this)->get_DeviceFont(pVal);
}

template <class T> TOLEBOOL __fastcall
TCOMIFlashVideoT<T>::get_DeviceFont(void)
{
  TOLEBOOL pVal;
  OLECHECK(this->get_DeviceFont((TOLEBOOL*)&pVal));
  return pVal;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::set_DeviceFont(TOLEBOOL pVal/*[in]*/)
{
  return (*this)->set_DeviceFont(pVal);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::get_EmbedMovie(TOLEBOOL* pVal/*[out,retval]*/)
{
  return (*this)->get_EmbedMovie(pVal);
}

template <class T> TOLEBOOL __fastcall
TCOMIFlashVideoT<T>::get_EmbedMovie(void)
{
  TOLEBOOL pVal;
  OLECHECK(this->get_EmbedMovie((TOLEBOOL*)&pVal));
  return pVal;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::set_EmbedMovie(TOLEBOOL pVal/*[in]*/)
{
  return (*this)->set_EmbedMovie(pVal);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::get_BGColor(BSTR* pVal/*[out,retval]*/)
{
  return (*this)->get_BGColor(pVal);
}

template <class T> BSTR __fastcall
TCOMIFlashVideoT<T>::get_BGColor(void)
{
  BSTR pVal = 0;
  OLECHECK(this->get_BGColor((BSTR*)&pVal));
  return pVal;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::set_BGColor(BSTR pVal/*[in]*/)
{
  return (*this)->set_BGColor(pVal);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::get_Quality2(BSTR* pVal/*[out,retval]*/)
{
  return (*this)->get_Quality2(pVal);
}

template <class T> BSTR __fastcall
TCOMIFlashVideoT<T>::get_Quality2(void)
{
  BSTR pVal = 0;
  OLECHECK(this->get_Quality2((BSTR*)&pVal));
  return pVal;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::set_Quality2(BSTR pVal/*[in]*/)
{
  return (*this)->set_Quality2(pVal);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::LoadMovie(int layer/*[in]*/, BSTR url/*[in]*/)
{
  return (*this)->LoadMovie(layer, url);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::TGotoFrame(BSTR target/*[in]*/, long FrameNum/*[in]*/)
{
  return (*this)->TGotoFrame(target, FrameNum);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::TGotoLabel(BSTR target/*[in]*/, BSTR label/*[in]*/)
{
  return (*this)->TGotoLabel(target, label);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::TCurrentFrame(BSTR target/*[in]*/, long* FrameNum/*[out,retval]*/)
{
  return (*this)->TCurrentFrame(target, FrameNum);
}

template <class T> long __fastcall
TCOMIFlashVideoT<T>::TCurrentFrame(BSTR target/*[in]*/)
{
  long FrameNum;
  OLECHECK(this->TCurrentFrame(target, (long*)&FrameNum));
  return FrameNum;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::TCurrentLabel(BSTR target/*[in]*/, BSTR* pVal/*[out,retval]*/)
{
  return (*this)->TCurrentLabel(target, pVal);
}

template <class T> BSTR __fastcall
TCOMIFlashVideoT<T>::TCurrentLabel(BSTR target/*[in]*/)
{
  BSTR pVal = 0;
  OLECHECK(this->TCurrentLabel(target, (BSTR*)&pVal));
  return pVal;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::TPlay(BSTR target/*[in]*/)
{
  return (*this)->TPlay(target);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::TStopPlay(BSTR target/*[in]*/)
{
  return (*this)->TStopPlay(target);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::SetVariable(BSTR name/*[in]*/, BSTR value/*[in]*/)
{
  return (*this)->SetVariable(name, value);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::GetVariable(BSTR name/*[in]*/, BSTR* pVal/*[out,retval]*/)
{
  return (*this)->GetVariable(name, pVal);
}

template <class T> BSTR __fastcall
TCOMIFlashVideoT<T>::GetVariable(BSTR name/*[in]*/)
{
  BSTR pVal = 0;
  OLECHECK(this->GetVariable(name, (BSTR*)&pVal));
  return pVal;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::TSetProperty(BSTR target/*[in]*/, int property/*[in]*/, BSTR value/*[in]*/)
{
  return (*this)->TSetProperty(target, property, value);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::TGetProperty(BSTR target/*[in]*/, int property/*[in]*/, 
                                      BSTR* pVal/*[out,retval]*/)
{
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::TCallFrame(BSTR target/*[in]*/, int FrameNum/*[in]*/)
{
  return (*this)->TCallFrame(target, FrameNum);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::TCallLabel(BSTR target/*[in]*/, BSTR label/*[in]*/)
{
  return (*this)->TCallLabel(target, label);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::TSetPropertyNum(BSTR target/*[in]*/, int property/*[in]*/, 
                                         double value/*[in]*/)
{
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::TGetPropertyNum(BSTR target/*[in]*/, int property/*[in]*/, 
                                         double* pVal/*[out,retval]*/)
{
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::TGetPropertyAsNumber(BSTR target/*[in]*/, int property/*[in]*/, 
                                              double* pVal/*[out,retval]*/)
{
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::get_SWRemote(BSTR* pVal/*[out,retval]*/)
{
  return (*this)->get_SWRemote(pVal);
}

template <class T> BSTR __fastcall
TCOMIFlashVideoT<T>::get_SWRemote(void)
{
  BSTR pVal = 0;
  OLECHECK(this->get_SWRemote((BSTR*)&pVal));
  return pVal;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::set_SWRemote(BSTR pVal/*[in]*/)
{
  return (*this)->set_SWRemote(pVal);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::get_FlashVars(BSTR* pVal/*[out,retval]*/)
{
  return (*this)->get_FlashVars(pVal);
}

template <class T> BSTR __fastcall
TCOMIFlashVideoT<T>::get_FlashVars(void)
{
  BSTR pVal = 0;
  OLECHECK(this->get_FlashVars((BSTR*)&pVal));
  return pVal;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::set_FlashVars(BSTR pVal/*[in]*/)
{
  return (*this)->set_FlashVars(pVal);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::get_AllowScriptAccess(BSTR* pVal/*[out,retval]*/)
{
  return (*this)->get_AllowScriptAccess(pVal);
}

template <class T> BSTR __fastcall
TCOMIFlashVideoT<T>::get_AllowScriptAccess(void)
{
  BSTR pVal = 0;
  OLECHECK(this->get_AllowScriptAccess((BSTR*)&pVal));
  return pVal;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::set_AllowScriptAccess(BSTR pVal/*[in]*/)
{
  return (*this)->set_AllowScriptAccess(pVal);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::get_MovieData(BSTR* pVal/*[out,retval]*/)
{
  return (*this)->get_MovieData(pVal);
}

template <class T> BSTR __fastcall
TCOMIFlashVideoT<T>::get_MovieData(void)
{
  BSTR pVal = 0;
  OLECHECK(this->get_MovieData((BSTR*)&pVal));
  return pVal;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::set_MovieData(BSTR pVal/*[in]*/)
{
  return (*this)->set_MovieData(pVal);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::get_InlineData(LPUNKNOWN* ppIUnknown/*[out,retval]*/)
{
  return (*this)->get_InlineData(ppIUnknown);
}

template <class T> LPUNKNOWN __fastcall
TCOMIFlashVideoT<T>::get_InlineData(void)
{
  LPUNKNOWN ppIUnknown;
  OLECHECK(this->get_InlineData((LPUNKNOWN*)&ppIUnknown));
  return ppIUnknown;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::set_InlineData(LPUNKNOWN ppIUnknown/*[in]*/)
{
  return (*this)->set_InlineData(ppIUnknown);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::get_SeamlessTabbing(TOLEBOOL* pVal/*[out,retval]*/)
{
  return (*this)->get_SeamlessTabbing(pVal);
}

template <class T> TOLEBOOL __fastcall
TCOMIFlashVideoT<T>::get_SeamlessTabbing(void)
{
  TOLEBOOL pVal;
  OLECHECK(this->get_SeamlessTabbing((TOLEBOOL*)&pVal));
  return pVal;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::set_SeamlessTabbing(TOLEBOOL pVal/*[in]*/)
{
  return (*this)->set_SeamlessTabbing(pVal);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::EnforceLocalSecurity(void)
{
  return (*this)->EnforceLocalSecurity();
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::get_Profile(TOLEBOOL* pVal/*[out,retval]*/)
{
  return (*this)->get_Profile(pVal);
}

template <class T> TOLEBOOL __fastcall
TCOMIFlashVideoT<T>::get_Profile(void)
{
  TOLEBOOL pVal;
  OLECHECK(this->get_Profile((TOLEBOOL*)&pVal));
  return pVal;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::set_Profile(TOLEBOOL pVal/*[in]*/)
{
  return (*this)->set_Profile(pVal);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::get_ProfileAddress(BSTR* pVal/*[out,retval]*/)
{
  return (*this)->get_ProfileAddress(pVal);
}

template <class T> BSTR __fastcall
TCOMIFlashVideoT<T>::get_ProfileAddress(void)
{
  BSTR pVal = 0;
  OLECHECK(this->get_ProfileAddress((BSTR*)&pVal));
  return pVal;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::set_ProfileAddress(BSTR pVal/*[in]*/)
{
  return (*this)->set_ProfileAddress(pVal);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::get_ProfilePort(long* pVal/*[out,retval]*/)
{
  return (*this)->get_ProfilePort(pVal);
}

template <class T> long __fastcall
TCOMIFlashVideoT<T>::get_ProfilePort(void)
{
  long pVal;
  OLECHECK(this->get_ProfilePort((long*)&pVal));
  return pVal;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::set_ProfilePort(long pVal/*[in]*/)
{
  return (*this)->set_ProfilePort(pVal);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::CallFunction(BSTR request/*[in]*/, BSTR* response/*[out,retval]*/)
{
  return (*this)->CallFunction(request, response);
}

template <class T> BSTR __fastcall
TCOMIFlashVideoT<T>::CallFunction(BSTR request/*[in]*/)
{
  BSTR response = 0;
  OLECHECK(this->CallFunction(request, (BSTR*)&response));
  return response;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::SetReturnValue(BSTR returnValue/*[in]*/)
{
  return (*this)->SetReturnValue(returnValue);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::DisableLocalSecurity(void)
{
  return (*this)->DisableLocalSecurity();
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::get_AllowNetworking(BSTR* pVal/*[out,retval]*/)
{
  return (*this)->get_AllowNetworking(pVal);
}

template <class T> BSTR __fastcall
TCOMIFlashVideoT<T>::get_AllowNetworking(void)
{
  BSTR pVal = 0;
  OLECHECK(this->get_AllowNetworking((BSTR*)&pVal));
  return pVal;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::set_AllowNetworking(BSTR pVal/*[in]*/)
{
  return (*this)->set_AllowNetworking(pVal);
}

template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::get_AllowFullScreen(BSTR* pVal/*[out,retval]*/)
{
  return (*this)->get_AllowFullScreen(pVal);
}

template <class T> BSTR __fastcall
TCOMIFlashVideoT<T>::get_AllowFullScreen(void)
{
  BSTR pVal = 0;
  OLECHECK(this->get_AllowFullScreen((BSTR*)&pVal));
  return pVal;
...
template <class T> HRESULT __fastcall
TCOMIFlashVideoT<T>::set_AllowFullScreen(BSTR pVal/*[in]*/)
{
...
// *********************************************************************//
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::get_ReadyState(long* pVal/*[out,retval]*/)
{
...
template <class T> long __fastcall
IFlashVideoDispT<T>::get_ReadyState(void)
{
  long pVal;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::get_TotalFrames(long* pVal/*[out,retval]*/)
{
...
template <class T> long __fastcall
IFlashVideoDispT<T>::get_TotalFrames(void)
{
  long pVal;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::get_Playing(TOLEBOOL* pVal/*[out,retval]*/)
{
...
template <class T> TOLEBOOL __fastcall
IFlashVideoDispT<T>::get_Playing(void)
{
  TOLEBOOL pVal;
  this->get_Playing((TOLEBOOL*)&pVal);
  return pVal;
}

template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::set_Playing(TOLEBOOL pVal/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("Playing"), DISPID(125));
  TAutoArgs<1> _args;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::get_Quality(int* pVal/*[out,retval]*/)
{
...
template <class T> int __fastcall
IFlashVideoDispT<T>::get_Quality(void)
{
  int pVal;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::set_Quality(int pVal/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("Quality"), DISPID(105));
  TAutoArgs<1> _args;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::get_ScaleMode(int* pVal/*[out,retval]*/)
{
...
template <class T> int __fastcall
IFlashVideoDispT<T>::get_ScaleMode(void)
{
  int pVal;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::set_ScaleMode(int pVal/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("ScaleMode"), DISPID(120));
  TAutoArgs<1> _args;
  _args[1] = pVal /*[VT_INT:0]*/;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::get_AlignMode(int* pVal/*[out,retval]*/)
{
...
template <class T> int __fastcall
IFlashVideoDispT<T>::get_AlignMode(void)
{
  int pVal;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::set_AlignMode(int pVal/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("AlignMode"), DISPID(121));
  TAutoArgs<1> _args;
  _args[1] = pVal /*[VT_INT:0]*/;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::get_BackgroundColor(long* pVal/*[out,retval]*/)
{
...
template <class T> long __fastcall
IFlashVideoDispT<T>::get_BackgroundColor(void)
{
  long pVal;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::set_BackgroundColor(long pVal/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("BackgroundColor"), DISPID(123));
  TAutoArgs<1> _args;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::get_Loop(TOLEBOOL* pVal/*[out,retval]*/)
{
...
template <class T> TOLEBOOL __fastcall
IFlashVideoDispT<T>::get_Loop(void)
{
  TOLEBOOL pVal;
  this->get_Loop((TOLEBOOL*)&pVal);
  return pVal;
}

template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::set_Loop(TOLEBOOL pVal/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("Loop"), DISPID(106));
  TAutoArgs<1> _args;
  _args[1] = pVal /*[VT_BOOL:0]*/;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::get_Movie(BSTR* pVal/*[out,retval]*/)
{
...
template <class T> BSTR __fastcall
IFlashVideoDispT<T>::get_Movie(void)
{
  BSTR pVal;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::set_Movie(BSTR pVal/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("Movie"), DISPID(102));
  TAutoArgs<1> _args;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::get_FrameNum(long* pVal/*[out,retval]*/)
{
...
template <class T> long __fastcall
IFlashVideoDispT<T>::get_FrameNum(void)
{
  long pVal;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::set_FrameNum(long pVal/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("FrameNum"), DISPID(107));
  TAutoArgs<1> _args;
  _args[1] = pVal /*[VT_I4:0]*/;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::SetZoomRect(long left/*[in]*/, long top/*[in]*/, long right/*[in]*/, 
                                     long bottom/*[in]*/)
{
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::Zoom(int factor/*[in]*/)
{
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::Pan(long x/*[in]*/, long y/*[in]*/, int mode/*[in]*/)
{
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::GotoFrame(long FrameNum/*[in]*/)
{
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::CurrentFrame(long* FrameNum/*[out,retval]*/)
{
...
template <class T> long __fastcall
IFlashVideoDispT<T>::CurrentFrame(void)
{
  long FrameNum;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::IsPlaying(TOLEBOOL* Playing/*[out,retval]*/)
{
...
template <class T> TOLEBOOL __fastcall
IFlashVideoDispT<T>::IsPlaying(void)
{
  TOLEBOOL Playing;
  this->IsPlaying((TOLEBOOL*)&Playing);
  return Playing;
}

template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::PercentLoaded(long* percent/*[out,retval]*/)
{
...
template <class T> long __fastcall
IFlashVideoDispT<T>::PercentLoaded(void)
{
  long percent;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::FrameLoaded(long FrameNum/*[in]*/, TOLEBOOL* loaded/*[out,retval]*/)
{
...
template <class T> TOLEBOOL __fastcall
IFlashVideoDispT<T>::FrameLoaded(long FrameNum/*[in]*/)
{
  TOLEBOOL loaded;
  this->FrameLoaded(FrameNum, (TOLEBOOL*)&loaded);
  return loaded;
}

template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::FlashVersion(long* version/*[out,retval]*/)
{
...
template <class T> long __fastcall
IFlashVideoDispT<T>::FlashVersion(void)
{
  long version;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::get_WMode(BSTR* pVal/*[out,retval]*/)
{
...
template <class T> BSTR __fastcall
IFlashVideoDispT<T>::get_WMode(void)
{
  BSTR pVal;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::set_WMode(BSTR pVal/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("WMode"), DISPID(133));
  TAutoArgs<1> _args;
  _args[1] = pVal /*[VT_BSTR:0]*/;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::get_SAlign(BSTR* pVal/*[out,retval]*/)
{
...
template <class T> BSTR __fastcall
IFlashVideoDispT<T>::get_SAlign(void)
{
  BSTR pVal;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::set_SAlign(BSTR pVal/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("SAlign"), DISPID(134));
  TAutoArgs<1> _args;
  _args[1] = pVal /*[VT_BSTR:0]*/;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::get_Menu(TOLEBOOL* pVal/*[out,retval]*/)
{
...
template <class T> TOLEBOOL __fastcall
IFlashVideoDispT<T>::get_Menu(void)
{
  TOLEBOOL pVal;
  this->get_Menu((TOLEBOOL*)&pVal);
  return pVal;
}

template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::set_Menu(TOLEBOOL pVal/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("Menu"), DISPID(135));
  TAutoArgs<1> _args;
  _args[1] = pVal /*[VT_BOOL:0]*/;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::get_Base(BSTR* pVal/*[out,retval]*/)
{
...
template <class T> BSTR __fastcall
IFlashVideoDispT<T>::get_Base(void)
{
  BSTR pVal;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::set_Base(BSTR pVal/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("Base"), DISPID(136));
  TAutoArgs<1> _args;
  _args[1] = pVal /*[VT_BSTR:0]*/;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::get_Scale(BSTR* pVal/*[out,retval]*/)
{
...
template <class T> BSTR __fastcall
IFlashVideoDispT<T>::get_Scale(void)
{
  BSTR pVal;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::set_Scale(BSTR pVal/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("Scale"), DISPID(137));
  TAutoArgs<1> _args;
  _args[1] = pVal /*[VT_BSTR:0]*/;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::get_DeviceFont(TOLEBOOL* pVal/*[out,retval]*/)
{
...
template <class T> TOLEBOOL __fastcall
IFlashVideoDispT<T>::get_DeviceFont(void)
{
  TOLEBOOL pVal;
  this->get_DeviceFont((TOLEBOOL*)&pVal);
  return pVal;
}

template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::set_DeviceFont(TOLEBOOL pVal/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("DeviceFont"), DISPID(138));
  TAutoArgs<1> _args;
  _args[1] = pVal /*[VT_BOOL:0]*/;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::get_EmbedMovie(TOLEBOOL* pVal/*[out,retval]*/)
{
...
template <class T> TOLEBOOL __fastcall
IFlashVideoDispT<T>::get_EmbedMovie(void)
{
  TOLEBOOL pVal;
  this->get_EmbedMovie((TOLEBOOL*)&pVal);
  return pVal;
}

template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::set_EmbedMovie(TOLEBOOL pVal/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("EmbedMovie"), DISPID(139));
  TAutoArgs<1> _args;
  _args[1] = pVal /*[VT_BOOL:0]*/;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::get_BGColor(BSTR* pVal/*[out,retval]*/)
{
...
template <class T> BSTR __fastcall
IFlashVideoDispT<T>::get_BGColor(void)
{
  BSTR pVal;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::set_BGColor(BSTR pVal/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("BGColor"), DISPID(140));
  TAutoArgs<1> _args;
  _args[1] = pVal /*[VT_BSTR:0]*/;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::get_Quality2(BSTR* pVal/*[out,retval]*/)
{
...
template <class T> BSTR __fastcall
IFlashVideoDispT<T>::get_Quality2(void)
{
  BSTR pVal;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::set_Quality2(BSTR pVal/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("Quality2"), DISPID(141));
  TAutoArgs<1> _args;
  _args[1] = pVal /*[VT_BSTR:0]*/;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::LoadMovie(int layer/*[in]*/, BSTR url/*[in]*/)
{
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::TGotoFrame(BSTR target/*[in]*/, long FrameNum/*[in]*/)
{
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::TGotoLabel(BSTR target/*[in]*/, BSTR label/*[in]*/)
{
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::TCurrentFrame(BSTR target/*[in]*/, long* FrameNum/*[out,retval]*/)
{
...
template <class T> long __fastcall
IFlashVideoDispT<T>::TCurrentFrame(BSTR target/*[in]*/)
{
  long FrameNum;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::TCurrentLabel(BSTR target/*[in]*/, BSTR* pVal/*[out,retval]*/)
{
...
template <class T> BSTR __fastcall
IFlashVideoDispT<T>::TCurrentLabel(BSTR target/*[in]*/)
{
  BSTR pVal;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::TPlay(BSTR target/*[in]*/)
{
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::TStopPlay(BSTR target/*[in]*/)
{
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::SetVariable(BSTR name/*[in]*/, BSTR value/*[in]*/)
{
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::GetVariable(BSTR name/*[in]*/, BSTR* pVal/*[out,retval]*/)
{
...
template <class T> BSTR __fastcall
IFlashVideoDispT<T>::GetVariable(BSTR name/*[in]*/)
{
  BSTR pVal;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::TSetProperty(BSTR target/*[in]*/, int property/*[in]*/, BSTR value/*[in]*/)
{
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::TGetProperty(BSTR target/*[in]*/, int property/*[in]*/, 
                                      BSTR* pVal/*[out,retval]*/)
{
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::TCallFrame(BSTR target/*[in]*/, int FrameNum/*[in]*/)
{
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::TCallLabel(BSTR target/*[in]*/, BSTR label/*[in]*/)
{
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::TSetPropertyNum(BSTR target/*[in]*/, int property/*[in]*/, 
                                         double value/*[in]*/)
{
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::TGetPropertyNum(BSTR target/*[in]*/, int property/*[in]*/, 
                                         double* pVal/*[out,retval]*/)
{
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::TGetPropertyAsNumber(BSTR target/*[in]*/, int property/*[in]*/, 
                                              double* pVal/*[out,retval]*/)
{
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::get_SWRemote(BSTR* pVal/*[out,retval]*/)
{
...
template <class T> BSTR __fastcall
IFlashVideoDispT<T>::get_SWRemote(void)
{
  BSTR pVal;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::set_SWRemote(BSTR pVal/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("SWRemote"), DISPID(159));
  TAutoArgs<1> _args;
  _args[1] = pVal /*[VT_BSTR:0]*/;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::get_FlashVars(BSTR* pVal/*[out,retval]*/)
{
...
template <class T> BSTR __fastcall
IFlashVideoDispT<T>::get_FlashVars(void)
{
  BSTR pVal;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::set_FlashVars(BSTR pVal/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("FlashVars"), DISPID(170));
  TAutoArgs<1> _args;
  _args[1] = pVal /*[VT_BSTR:0]*/;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::get_AllowScriptAccess(BSTR* pVal/*[out,retval]*/)
{
...
template <class T> BSTR __fastcall
IFlashVideoDispT<T>::get_AllowScriptAccess(void)
{
  BSTR pVal;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::set_AllowScriptAccess(BSTR pVal/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("AllowScriptAccess"), DISPID(171));
  TAutoArgs<1> _args;
  _args[1] = pVal /*[VT_BSTR:0]*/;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::get_MovieData(BSTR* pVal/*[out,retval]*/)
{
...
template <class T> BSTR __fastcall
IFlashVideoDispT<T>::get_MovieData(void)
{
  BSTR pVal;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::set_MovieData(BSTR pVal/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("MovieData"), DISPID(190));
  TAutoArgs<1> _args;
  _args[1] = pVal /*[VT_BSTR:0]*/;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::get_InlineData(LPUNKNOWN* ppIUnknown/*[out,retval]*/)
{
...
template <class T> LPUNKNOWN __fastcall
IFlashVideoDispT<T>::get_InlineData(void)
{
  LPUNKNOWN ppIUnknown;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::set_InlineData(LPUNKNOWN ppIUnknown/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("InlineData"), DISPID(191));
  TAutoArgs<1> _args;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::get_SeamlessTabbing(TOLEBOOL* pVal/*[out,retval]*/)
{
...
template <class T> TOLEBOOL __fastcall
IFlashVideoDispT<T>::get_SeamlessTabbing(void)
{
  TOLEBOOL pVal;
  this->get_SeamlessTabbing((TOLEBOOL*)&pVal);
  return pVal;
}

template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::set_SeamlessTabbing(TOLEBOOL pVal/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("SeamlessTabbing"), DISPID(192));
  TAutoArgs<1> _args;
  _args[1] = pVal /*[VT_BOOL:0]*/;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::EnforceLocalSecurity()
{
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::get_Profile(TOLEBOOL* pVal/*[out,retval]*/)
{
...
template <class T> TOLEBOOL __fastcall
IFlashVideoDispT<T>::get_Profile(void)
{
  TOLEBOOL pVal;
  this->get_Profile((TOLEBOOL*)&pVal);
  return pVal;
}

template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::set_Profile(TOLEBOOL pVal/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("Profile"), DISPID(194));
  TAutoArgs<1> _args;
  _args[1] = pVal /*[VT_BOOL:0]*/;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::get_ProfileAddress(BSTR* pVal/*[out,retval]*/)
{
...
template <class T> BSTR __fastcall
IFlashVideoDispT<T>::get_ProfileAddress(void)
{
  BSTR pVal;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::set_ProfileAddress(BSTR pVal/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("ProfileAddress"), DISPID(195));
  TAutoArgs<1> _args;
  _args[1] = pVal /*[VT_BSTR:0]*/;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::get_ProfilePort(long* pVal/*[out,retval]*/)
{
...
template <class T> long __fastcall
IFlashVideoDispT<T>::get_ProfilePort(void)
{
  long pVal;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::set_ProfilePort(long pVal/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("ProfilePort"), DISPID(196));
  TAutoArgs<1> _args;
  _args[1] = pVal /*[VT_I4:0]*/;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::CallFunction(BSTR request/*[in]*/, BSTR* response/*[out,retval]*/)
{
...
template <class T> BSTR __fastcall
IFlashVideoDispT<T>::CallFunction(BSTR request/*[in]*/)
{
  BSTR response;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::SetReturnValue(BSTR returnValue/*[in]*/)
{
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::DisableLocalSecurity()
{
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::get_AllowNetworking(BSTR* pVal/*[out,retval]*/)
{
...
template <class T> BSTR __fastcall
IFlashVideoDispT<T>::get_AllowNetworking(void)
{
  BSTR pVal;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::set_AllowNetworking(BSTR pVal/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("AllowNetworking"), DISPID(201));
  TAutoArgs<1> _args;
  _args[1] = pVal /*[VT_BSTR:0]*/;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::get_AllowFullScreen(BSTR* pVal/*[out,retval]*/)
{
...
template <class T> BSTR __fastcall
IFlashVideoDispT<T>::get_AllowFullScreen(void)
{
  BSTR pVal;
...
template <class T> HRESULT __fastcall
IFlashVideoDispT<T>::set_AllowFullScreen(BSTR pVal/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("AllowFullScreen"), DISPID(202));
  TAutoArgs<1> _args;
  _args[1] = pVal /*[VT_BSTR:0]*/;
...
_IFlashVideoEventsDispT<T>::OnReadyStateChange(long newState)
{
  _TDispID _dispid(/* OnReadyStateChange */ DISPID(-609));
  TAutoArgs<1> _args;
  _args[1] = newState /*[VT_I4:0]*/;
...
template <class T> void __fastcall
_IFlashVideoEventsDispT<T>::OnProgress(long percentDone)
{
  _TDispID _dispid(/* OnProgress */ DISPID(1958));
  TAutoArgs<1> _args;
  _args[1] = percentDone /*[VT_I4:0]*/;
...
template <class T> void __fastcall
_IFlashVideoEventsDispT<T>::FSCommand(BSTR command/*[in]*/, BSTR args/*[in]*/)
{
  _TDispID _dispid(/* FSCommand */ DISPID(150));
  TAutoArgs<2> _args;
  _args[1] = command /*[VT_BSTR:0]*/;
...
template <class T> void __fastcall
_IFlashVideoEventsDispT<T>::FlashCall(BSTR request/*[in]*/)
{
  _TDispID _dispid(/* FlashCall */ DISPID(197));
  TAutoArgs<1> _args;
  _args[1] = request /*[VT_BSTR:0]*/;
                                     ...
                                     TVariant* rgvarRefArg/*[in,out]*/)
{
  ...
  _args[4] = pdp /*[VT_USERDEFINED:1]*/;
  _args[5] = pvarRes /*[VT_VARIANT:1]*/;
  _args[6] = pei /*[VT_USERDEFINED:1]*/;
  _args[7] = (LPUNKNOWN)(Flashvideoobjects_tlb::IServiceProvider*)pspCaller /*[VT_USERDEFINED:1]*/;
...
// *********************************************************************//
template <class T>
class TEvents_FlashVideo : public IConnectionPointImpl<T,
                                                 &DIID__IFlashVideoEvents,
...
protected:
  _IFlashVideoEventsDisp m_EventIntfObj;
};

template <class T> void
TEvents_FlashVideo<T>::Fire_OnReadyStateChange(long newState)
{
  T * pT = (T*)this;
  pT->Lock();
...
template <class T> void
TEvents_FlashVideo<T>::Fire_OnProgress(long percentDone)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_FlashVideo<T>::Fire_FSCommand(BSTR command, BSTR args)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_FlashVideo<T>::Fire_FlashCall(BSTR request)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
#endif // __FlashVideoObjects_TLB_h__
